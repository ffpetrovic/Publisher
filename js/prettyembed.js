	...
	$.fn.prettyEmbed = function (options) {
		...
		elem.each(function() {
			...
			if ( thisCustomPreviewImage !== undefined && thisCustomPreviewImage !== '' ) {
				$(this).html('<img src="' + "http:" + thisCustomPreviewImage + '" width="100%" alt="YouTube Video Preview" />');
			}
			else {
		...
		function clickEventRunner(obj) {
			...
			obj.html('<iframe width="' + wrapperWidth + '" height="' + wrapperHeight + '" ' + fullScreenFlag + 'style="border:none;" src="http://www.youtube.com/embed/' + thisVideoID + '?autoplay=1' + playerOptions + '"></iframe>')
